# Takesend Logistics Tracking API For PHP
Takesend Logistics Tracking API and webhook make it easy to integrate Takesend Logistics Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Takesend Logistics Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Takesend Logistics Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Takesend Logistics Tracking API](https://www.trackingmore.com/takesend-tracking.html)  to:

   *   Get Takesend Logistics realtime tracking info of muti-carriers in one integration
   *   Provide Takesend Logistics shipment tracking experience like Amazon
   *   Push Takesend Logistics notifications of package update with webhook
   *   Verify Takesend Logistics delivery exception before it is too late
