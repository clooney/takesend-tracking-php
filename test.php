...
//$trackingNumber = 'TSLEP3000000992YQ';
...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('takesend','TSLEP3000000992YQ',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "TSLEP3000000992YQ",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("takesend","TSLEP3000000992YQ",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'TSLEP3000000992YQ',
//        'carrier_code'    => 'takesend',
//        'title'          => '4PX page',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('takesend','TSLEP3000000992YQ',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('takesend','TSLEP3000000992YQ');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("takesend","TSLEP3000000992YQ",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("TSLEP3000000992YQ","takesend","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"TSLEP3000000992YQ","carrier_code"=>"takesend");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"takesend");
